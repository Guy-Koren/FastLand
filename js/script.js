Parse.initialize("Gx1N6yiITBkVBHL4hJgtvv5fTpoABUXSrbqoSA14", "b0O2b0szAG9jNhHxQBZEBBtYKqqrDuZ3C1nGZPNd");
...
function addEmailToDB(email,name,phone){
    if(email&&name&&phone) {
        var GameScore = Parse.Object.extend("Contacted");
